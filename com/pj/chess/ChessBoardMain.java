...
//		jpNorth.setBackground(Color.white);
	...
	public ChessBoardMain() {
		...
		Button computerMove = new Button("下一步");
	...
	JRadioButtonMenuItem hashSize2M = new JRadioButtonMenuItem("alpha",true);
	JRadioButtonMenuItem hashSize32M = new JRadioButtonMenuItem("beta",false);
	JRadioButtonMenuItem hashSize64M = new JRadioButtonMenuItem("gamma",false);
	private JMenuBar setJMenuBar(){
		JMenuBar jmb = new JMenuBar();
		JMenu menu_file = new JMenu("文件");
		JMenuItem create = new JMenuItem("新建");
		JMenuItem save= new JMenuItem("保存");
		JRadioButtonMenuItem mi_6 = new JRadioButtonMenuItem("ALPHA",true);
		JRadioButtonMenuItem mi_7 = new JRadioButtonMenuItem("BRAVO",false);
		JRadioButtonMenuItem mi_8 = new JRadioButtonMenuItem("CHARLIE",false);
		JRadioButtonMenuItem mi_9 = new JRadioButtonMenuItem("DELTA",false);
		JRadioButtonMenuItem mi_10 = new JRadioButtonMenuItem("ECHO",false);
		JRadioButtonMenuItem mi_11 = new JRadioButtonMenuItem("FOXTROT",false);
		...
		JCheckBoxMenuItem backstageThink=new JCheckBoxMenuItem("步数显示",isBackstageThink);
